...
class Requests(private val context: Context) {
  ...
  private val appIOSVersion = "4.24.0"
  private val appIOSBuild = "20523"
  ...
  private fun defaultHeaders(deviceId: String): Headers {
    return Headers.Builder()
            ...
            .add(
                    "user-agent",
                    "BeReal/$appIOSVersion ($appIOSBundleId; build:$appIOSBuild; iOS 19.0.0)"
            )
            .build()
  }
